# PhantomDev IDE Rules for Claude

## Overview
These rules help configure Claude IDE to write code with human-like patterns while maintaining professional quality.
...
1. Install this skill in your Claude configuration
